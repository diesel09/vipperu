...
echo -e "\033[1;32m[$i] $arqsx ($(cat ${DIR}/${arqs}.name))\033[1;33m (⚠️𝐒𝐈𝐍 𝐔𝐒𝐎)\033[0m"
else
echo -e "\033[1;31m[$i] $arqsx ($(cat ${DIR}/${arqs}.name))\033[1;33m ($(cat ${DIR}/${arqs}/used.date) IP: $(cat ${DIR}/${arqs}/✅𝐔𝐒𝐄𝐃))\033[0m"
fi
keys="$keys $arqs"
let i++
done
