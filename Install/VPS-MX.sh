...
echo 'echo -e "\033[0;30m  ✅RESELLER : $mess1 "'>> .bashrc
echo 'echo "" '>> .bashrc                                               
echo 'echo -e "\033[0;30m   PARA MOSTRAR EL PANEL DE CONTROL ESCRIBA:  menu "'>> .bashrc
...
cd $HOME
wget -O $HOME/lista-arq $(ofus "$Key")/$IP > /dev/null 2>&1 && echo -e "\033[0;32m ✅𝐊𝐄𝐘 𝐂𝐎𝐑𝐑𝐄𝐂𝐓𝐋𝐘 𝐕𝐄𝐑𝐈𝐅𝐈𝐄𝐃.::" || {
   echo -e "\033[0;31m ⚠️𝐈𝐍𝐂𝐎𝐑𝐑𝐄𝐂𝐓 𝐂𝐎𝐃𝐄.:::"
   invalid_key
   exit
   }
